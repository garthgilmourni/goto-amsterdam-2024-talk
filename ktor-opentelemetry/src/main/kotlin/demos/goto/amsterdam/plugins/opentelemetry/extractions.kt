// NOTE: this file contains some extractions for OpenTelemetry `KtorServerTracing` plugin
// They will be added to the plugin in the next `opentelemetry-java-instrumentation` release:
// https://github.com/open-telemetry/opentelemetry-java-instrumentation/pull/10963

package demos.goto.amsterdam.plugins.opentelemetry
